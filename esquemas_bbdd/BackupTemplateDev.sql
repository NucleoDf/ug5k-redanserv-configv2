...
INSERT INTO `configuraciones` VALUES (8,'MADRID-CENTRO','Zona Madrid Centro',NULL,1,'2017-09-07 10:33:03');
...
INSERT INTO `emplazamientos` VALUES (21,'ACC',8),(22,'TWR-N',8),(23,'ALCOLEA',8);
...
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=751 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lista_uris` VALUES (117,108,'sip:negra1@1.1.1.1:4040','LSN',0),(118,108,'sip:negra2@1.1.1.1:4040','LSN',0),(121,109,'sip:aaa@1.1.1.1:4040','TXA',1),(122,109,'sip:bbb@2.2.2.2:3030','RXA',1),(123,110,'sip:negra1@1.1.1.1:4040','LSN',0),(124,110,'sip:negra2@1.1.1.1:4040','LSN',0),(125,111,'sip:aaa@1.1.1.1:4040','TXA',1),(126,111,'sip:bbb@2.2.2.2:3030','RXA',1);
...
INSERT INTO `recursos_telefono` VALUES (27,15,1,0,'ttt',0,NULL,0,0,1,0,1,-15,0,0,0,0,'','',0,5,5,'sip:pepe@1.1.1.1:5050'),(28,33,1,0,'ttt',0,'null',0,0,1,0,1,-15,0,0,0,0,'','',0,5,5,'sip:pepe@1.1.1.1:5050');
...
-- Dump completed on 2017-09-13  9:58:21
