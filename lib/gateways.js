...
exports.getRadioRes4Gateway = function getRadioRes4Gateway(resourceId, f){
	...
	connection.connect(function(err){
		if (err){
			...
			var querySel = connection.query('SELECT rr.nombre,rr.codec,rr.clave_registro,rr.frecuencia,rr.ajuste_ad,' +
				'rr.ajuste_da,rr.precision_audio,rr.tipo_agente,rr.indicacion_entrada_audio,rr.indicacion_salida_audio,'+
				'rr.metodo_bss,rr.retraso_interno_grs,rr.tabla_bss_id,rr.tabla_bss_id,rr.umbral_vad '+
