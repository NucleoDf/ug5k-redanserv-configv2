		...
		if (err){
			...
			function(err,rows){
				...
				if (err != null) {
					...
					'(emplazamiento_id, nombre, ip_virtual, ultima_actualizacion '+
						//', ip_cpu0, ip_gtw0, mask_cpu0, ip_cpu1, ' +
					//'ip_gtw1, mask_cpu1, puerto_sip, periodo_supervision, puerto_servicio_snmp, puerto_snmp, snmpv2, ' +
					...
					'VALUES ' +
					'(?,?,?, NOW())', [rows[0].emplazamiento_id,targetNameGateway,ip_virtual],
