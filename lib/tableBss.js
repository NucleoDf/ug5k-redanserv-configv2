...
/*  REV 1.0.2 VMG				*/
/********************************/
exports.deleteTableBss_v2 = function (idTable,f){

	ug5kdb.Query('SELECT COUNT(*) AS nres FROM recursos_radio WHERE tabla_bss_id = ?', idTable, function(err, rows){
		console.log(rows);
