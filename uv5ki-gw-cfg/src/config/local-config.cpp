...
/**
 */
string LocalConfig::IdentToKey(string ident) {
    MapString::iterator itIden = _strings.ToKey.find(ident);
...
string LocalConfig::ConfigFile()
{
	...
	return GetIniSetting(ini, strSection, strItemConfigFile, "gw_config.json");
}
