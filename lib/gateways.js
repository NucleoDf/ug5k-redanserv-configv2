		...
		if (err){
			...
			function(err,rows){
				...
				if (err != null) {
					...
					var queryInsert =
					connection.query('INSERT INTO pasarelas (EMPLAZAMIENTO_idEMPLAZAMIENTO,REGIONES_idREGIONES,servicio,name,dualidad,ipv,ips,nivelconsola,puertoconsola,nivelIncidencias) ' +
					...
					'FROM CGW WHERE idCGW=?', [targetNameGateway, sourceIdGateway],
