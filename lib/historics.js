...
exports.postHistorics =  async function postHistorics(Incidencia, f) {
	var query1 = '(SELECT e.name FROM emplazamiento e ' +
	...
	/** Para Pruebas... */
	/*for (var i=0; i<20; i++) {
		var query1 = 'INSERT INTO temp (valor1) values (55);'
		var query2 = 'INSERT INTO temp (valor1) values (44);'
		var res = await ug5kdb.QueryMultiInsertSync(query1 + query2);
		console.log(res);
	}*/
